...
- Si "inseeProfile" est présent, tu peux ajouter **au plus une phrase** sur le profil résidentiel et social, et **seulement** pour ce qui s'écarte nettement du national fourni (au moins 10 points pour une part de logements ou de CSP, 3 points pour le chômage, 0,3 personne pour la taille des ménages). Décris en langage courant ("parc surtout locatif", "logements plus anciens que la moyenne", "beaucoup de personnes vivant seules", "population plus diplômée que la moyenne"). Un indicateur proche du national n'apprend rien : ne l'écris pas. N'énumère jamais plusieurs pourcentages à la suite.
